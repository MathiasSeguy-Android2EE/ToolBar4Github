...
package com.android2ee.formation.lollipop.toolbar.tabsnav.viewpagers.fragments;
...
public abstract class MotherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txvTitle= (TextView) myView.findViewById(R.id.txvTitle);
        btnButton= (Button) myView.findViewById(R.id.btnButton);
        imvPicture= (ImageView) myView.findViewById(R.id.imvPicture);
        update(myView);
        return myView ;
    }
